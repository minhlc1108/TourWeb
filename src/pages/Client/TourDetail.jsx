...
export default function TourDetail() {
    ...
    const handleSlideChange = (action) => {
        if (swiperRef.current) {
            if (action === "next") {
                if (data?.images?.length - 1 === currentIndex) {
                    setCurrentIndex(0);
                ...
                if (currentIndex === 0) {
                    ...
                    swiperRef.current.slideTo(data?.images?.length - 1);
                }
                else {
                    setCurrentIndex(prev => prev - 1);
                    swiperRef.current.slideTo(currentIndex - 1);
    ...
    const handleChange = (item) => {
        setCurrentIndex(item?.activeIndex || 0);
    };
                    ...
                    <div>
                        ...
                        <div ref={calendarRef}>
                            {detailTour ? (
                                ...
                                <div
                                    className={`calendar-container ${data?.schedules[0]?.remain === 0 ||
                        ...
                        <div className="p-5 ">
                            ...
                            {detailTour ? (
                                ...
                                <button
                                    ...
                                    className={`w-full bg-red-600 text-white text-xl h-[50px] mt-[20px] rounded-lg ${data?.schedules[0]?.remain === 0 ||
                                        dayjs(data?.departure).isBefore(dayjs(), "day")

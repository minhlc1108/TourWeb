...
const RegisterComponent = ({ onRegisterSuccess }) => {
  ...
  const handleRegister = async (values) => {
    ...
    setLoading(true);
    await registerAPI(formattedValues)
      .then(() => {
    ...
    <>
      ...
      >
              ...
              validator: (_, value) => {
                ...
                if (!hasUpperCase) {
                  return Promise.reject(
                    new Error("Mật khẩu phải có ít nhất 1 chữ hoa.")
                  );
                }
                if (!hasLowerCase) {
                  return Promise.reject(
                    new Error("Mật khẩu phải có ít nhất 1 chữ thường.")
                  );
                }
                if (!hasNumber) {
                  return Promise.reject(
        ...
        <Form.Item
          ...
          rules={[
            { required: true, message: "Vui lòng nhập tên!", whitespace: true },
          ]}
        >
          <Input />
        </Form.Item>
